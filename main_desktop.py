...
def main():
    ...
    if login.exec() == QDialog.DialogCode.Accepted:
        ...
        licencia_data = getattr(login, 'licencia_autorizada', None)
        ...
        if cliente_data and licencia_data:
            ...
            try:
                window = MainWindow(cliente_data, licencia_data, hwid)
                window.show()
            ...
            QMessageBox.critical(None, "Error de Sesión", "No se pudieron recuperar los datos del usuario o licencia.")
            sys.exit(1)
